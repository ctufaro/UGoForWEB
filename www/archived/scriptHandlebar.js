...
var SignOrLogin = function () {
    ...
    var Render = function () {
        $("#tmpl-content").hide();
        $("#tmpl-topnavbar").hide();
        $('#tmpl-signOrLogin').show();
        $('#tmpl-signOrLogin').html(Handlebars.compile($("#signOrLogin-template").html()));
    }
...
var SignUp = function () {
    ...
    var Render = function () {
        ...
        var theTemplateScript = $("#topnav-template").html();
        var theTemplate = Handlebars.compile(theTemplateScript);

        var context = {
            "leftthref": "#signOrLogin",
            "leftsrc": "img/menu/left-arrow.png",
            "righthref": "",
            "rightsrc": Constants.SrcBlank,
            "mainsrc": "img/logo.png"
        };

        var theCompiledHtml = theTemplate(context);

        $("#tmpl-signOrLogin").hide();
        $("#tmpl-content").show();
        $("#tmpl-topnavbar").show();
        $('#tmpl-topnavbar').html(theCompiledHtml);
        $('#tmpl-content').html(Handlebars.compile($("#signin-template").html()));
    }
...
var Login = function () {
    var Render = function () {
        ...
        $("#tmpl-topnavbar").show();
        $('#tmpl-topnavbar').html(theCompiledHtml);
        $('#tmpl-content').html(Handlebars.compile($("#login-template").html()));
    }
    return { Render: Render }
}();
...
var Constants = function () {
    ...
    var SrcBlank = 'data:image/gif;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs=';

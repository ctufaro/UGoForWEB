                ...
                var directive = {
                    'article': {
                        'post<-': { //for each entry in posts name the element 'post'
                            ...
                            '.yum-icon-img@class+': function (a) { if (a.item.Yummed === true) { return ' yum-icon-fill-img'; } },
                            '.gross-icon-img@class+': function (a) { if (a.item.Yucked === true) { return ' gross-icon-fill-img'; } },
